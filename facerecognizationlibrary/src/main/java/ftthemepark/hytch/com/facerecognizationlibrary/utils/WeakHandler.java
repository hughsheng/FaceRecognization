...
public class WeakHandler {
	...
	@VisibleForTesting
	private final ChainedRef runnable = new ChainedRef(mLock, null);
	...
	public final void removeCallbacks(Runnable r) {
		final WeakRunnable runnable = this.runnable.remove(r);
		if (runnable != null) {
